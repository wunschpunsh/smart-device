...
/* harmony import */ var _modules_modals_accordion_js__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./modules/modals/accordion.js */ "./js/modules/modals/accordion.js");
/* harmony import */ var _modules_modals_show_more_js__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./modules/modals/show-more.js */ "./js/modules/modals/show-more.js");
/* harmony import */ var _modules_modals_form_js__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./modules/modals/form.js */ "./js/modules/modals/form.js");
...
window.addEventListener('DOMContentLoaded', function () {
  ...
  window.addEventListener('load', function () {
    ...
    Object(_modules_modals_accordion_js__WEBPACK_IMPORTED_MODULE_2__["activateFooterAccordion"])();
    Object(_modules_modals_show_more_js__WEBPACK_IMPORTED_MODULE_3__["showMore"])();
    Object(_modules_modals_form_js__WEBPACK_IMPORTED_MODULE_4__["submitFeedBackForm"])();
  });
});
...
/* harmony import */ var _validate_form_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./validate-form.js */ "./js/modules/modals/validate-form.js");
/* harmony import */ var _result_message_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./result-message.js */ "./js/modules/modals/result-message.js");


var formElements = _validate_form_js__WEBPACK_IMPORTED_MODULE_0__["feedBackForm"].elements;
...
var getFormData = function getFormData(formNode) {
...
var onFormSumbit = function onFormSumbit(evt) {
  evt.preventDefault();
  var data = getFormData(evt.target);
  sendFormData(data);
};
var submitFeedBackForm = function submitFeedBackForm() {
  _validate_form_js__WEBPACK_IMPORTED_MODULE_0__["feedBackForm"].addEventListener('submit', onFormSumbit);
};
...
/***/ "./js/modules/modals/result-message.js":
/*!*********************************************!*\
  !*** ./js/modules/modals/result-message.js ***!
  \*********************************************/
...
/*!********************************************!*\
  !*** ./js/modules/modals/validate-form.js ***!
  \********************************************/
/*! exports provided: feedBackForm, validateForm */
/***/ (function(module, __webpack_exports__, __webpack_require__) {
...
var formButton = feedBackForm.querySelector('.form__send-button');
var phoneInput = feedBackForm.querySelector('#user-phone');
var nameInput = feedBackForm.querySelector('#user-name');
var personalInput = feedBackForm.querySelector('#personal-data');
var MASK_PHONE_FORMAT = '+7(';
var formattedInputValue;
var validatenameInput = function validatenameInput() {
...
var checkLengthPhoneNumber = function checkLengthPhoneNumber() {
  var isValid = phoneInput.checkValidity();
  if (!isValid) {
